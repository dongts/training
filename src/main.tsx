...
const QuizApp = () => {
  ...
  const quizData = [
    ...
    },
    {
      ...
      "answer_letter": "A",
      "answer_explanation": "Qui định thi hành Điều lệ Đảng số 294-QĐ/TW ngày 26/5/2025 của BCHTW ở điểm 9.3.2, Điều 9 đã ghi: “ Số thành viên của đại hội đảng viên, hội nghị đảng viên là tổng số đảng viên chính thức trong đảng bộ, chi bộ được triệu tập (trừ số đảng viên đã được giới thiệu sinh hoạt tạm thời ở đảng bộ khác và đảng viên đã được miễn công tác và sinh hoạt đảng không có mặt ở hội nghị (nếu đảng viên đó có mặt ở hội nghị đảng viên, tham gia biểu quyết thì vẫn tính).\nCăn cứ qui định trên, 03 đảng viên chính thức của chi bộ không thuộc diện được miễn công tác và sinh hoạt đảng khi vắng mặt không tham dự đại hội vẫn được tính vào tổng số đảng viên của chi bộ để tính kết quả bầu cử"
    },
    {
      "source": "Sheet1",
      "number": 4,
    ...
    },
    {
      ...
      "answer_letter": "A",
      "answer_explanation": "Căn cứ Điều 5, khoản 4 Điều lệ Đảng, Đảng viên đã được công nhận chính thức thì tuổi đảng của đảng viên tính từ ngày ghi trong quyết định kết nạp. Ở đây, quyết định kết nạp đảng của đồng chí X là ngày 25/8/2024 nên tuổi đảng được tính từ ngày này"
    },
    {
      "source": "Sheet1",
      "number": 7,
    ...
    },
    {
      ...
      "options": [
        ...
        "Chỉ cho phép ghi âm khi đối tượng kiểm tra trình bày ý kiên"
      ],
      "answer_letter": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        "Đăng những thông tin thuộc danh mục bí mật của Đảng và Nhà nước do cơ quan, tổ chức có thẩm quyền ban hành."
      ],
      "answer_letter": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        "Quy định số 24- QĐ/TW ngày 30/07/2021 về thi hành Điều lệ Đảng"
      ],
      "answer_letter": "B",
      "answer_explanation": ""
    },
    {
      ...
      "options": [
        ...
        "Hai đảng viên chính thức, Ban chấp hành đoàn cơ sở và Ban chấp hành công đoàn cơ sở giới thiệu"
      ],
      "answer_letter": "A",
    ...
    },
    {
      ...
      "options": [
        ...
        "Hạn chế tối đa việc tuyển dụng bù đắp, bố trí nhân sự thay thế từ nguồn tại chỗ cho phù hợp đối với các\ntrường hợp lao động hỗ trợ/lao động giản đơn nghỉ hưu/chấm dứt hợp đồng lao động/điều động đi đơn vị khác trong năm"
      ],
      "answer_letter": "D",
      "answer_explanation": "Nghị quyết 2537-NQ/ĐU ngày 06/03/2025"
    },
